...
<form name="form1" action="song.do?action=add" onSubmit="return checkform(form1)">
  <table width="500" height="241" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td><input name="fileURL" type="text" id="fileURL" size="30" readonly="yes" title="歌曲文件">
        <input name="upMusic" type="button" class="btn_grey" value="上传文件"   onClick="javascript:window.open('upFile.jsp','','width=350,height=150');"></td>
    </tr>
    <tr>
      <td align="center">歌词文件：</td>
      <td><input name="lrcFileURL" type="text" id="lrcFileURL" size="30" readonly="yes" title="歌词文件">
        <input name="lrcUp" type="button" class="btn_grey" value="上传文件"   onClick="javascript:go()">
...
function go(){
	var name = "";
	name = document.getElementById("fileURL").value;
	window.open('upLrcFile.jsp?fileName='+name,'','width=350,height=150');
}
